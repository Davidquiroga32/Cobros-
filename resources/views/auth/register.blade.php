    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .custom-logo-img {
            ...
            filter: brightness(0) invert(1); /* Opcional: vuelve el logo blanco si es oscuro */
        }
        .logo-icon-container {
            width: 48px;           /* Tamaño del cuadro */
            height: 48px;
            background: var(--accent); /* Fondo azul cobalto */
            border-radius: 12px;   /* Bordes redondeados suaves */
            display: flex;
            align-items: center;
            justify-content: center;
            box-shadow: 0 0 20px rgba(79, 142, 247, 0.3); /* Resplandor suave */
            overflow: hidden;      /* Corta la imagen si es muy grande */
            padding: 8px;          /* Espacio interno para que el logo no toque los bordes */
        }
        .brand {
            display: flex;
            align-items: center;
